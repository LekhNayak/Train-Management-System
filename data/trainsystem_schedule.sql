...
CREATE TABLE `schedule` (
  ...
  `departfromsource` datetime DEFAULT NULL,
  `arrivetodestination` datetime DEFAULT NULL,
  UNIQUE KEY `id` (`id`),
  KEY `train_no` (`train_no`),
  CONSTRAINT `schedule_ibfk_1` FOREIGN KEY (`train_no`) REFERENCES `train` (`train_no`)
